...
Route::middleware([
    ...
    Route::get('/dashboard', function () {
        return Inertia::render('Dashboard', [
            'canCreate' => true, // ✅ connecté → bouton "Créer un voyage"
        ]);
    })->name('dashboard');
    ...
    // Mise à jour nuits + date de départ (cascade autoritaire)
